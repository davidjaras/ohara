...
const es = {
  ...
  training: {
    ...
    cardNone: 'Todavía no elegiste un plan.',
    cardPickPlan: 'Elegir un plan',
    cardWeekOf: 'Semana {{week}} de {{total}}',
    cardToday: 'Hoy',
    cardNext: 'Próximo',
    cardRestDay: 'Hoy descansas.',
    cardPlanOver: 'Tu plan terminó el {{date}}.',
    cardPlanOverPending: 'Tu plan terminó el {{date}} · te faltan {{count}} entrenamientos.',
    cardFinishPlan: 'Terminar plan',
    cardKeepGoing: 'Seguir',
    ...
    planDates: '{{start}} → {{end}}',
    planProgress: '{{done}} de {{planned}} entrenamientos',
    planWeeks: '{{count}} semanas',
    startPlan: 'Empezar',
    startPlanTitle: 'Empezar {{name}}',
    startPlanDescription:
      'El plan se agenda semana a semana desde el lunes que elijas, con cada día en su día de la semana.',
    startPlanDate: 'Empieza el lunes',
    startPlanSummary: '{{weeks}} semanas · termina el {{end}}',
    startPlanConfirm: 'Empezar el plan',
    startPlanReplace: 'Esto abandona tu plan actual ({{name}}). Lo ya registrado se conserva.',
    startPlanRoutine: 'Rutina',
    starting: 'Empezando…',
    thisWeek: 'Esta semana',
    weekAdherence: '{{done}}/{{planned}}',
    status_today: 'Hoy',
    status_late: 'Atrasado',
    status_ahead: 'Adelantado',
    status_offPlan: 'Fuera de plan',
    lastTime: 'Última vez · {{when}}: {{sets}}',
    lastTimeNever: 'Sin registros previos',
    historyDescription: 'Todas las veces que registraste este ejercicio, de la más reciente a la más antigua.',
    historyEmpty: 'Todavía no registraste este ejercicio.',
    historyUndated: 'sin fecha',
    historySubstituted: 'sust.',
    routineTitle: 'Rutina',
    routineDescription: 'Este programa tiene varias rutinas; elige la que vas a seguir.',
    routineDays: '{{count}} días/semana',
    routineCount: '{{count}} rutinas disponibles',
    pickRoutine: 'Elige una rutina para activar este programa.',
    envGym: 'gimnasio',
    envHome: 'casa',
    activeTag: 'activa',
    useRoutine: 'Usar esta rutina',
    activate: 'Activar',
    activeProgramTag: 'Activo',
    phase: 'Fase {{number}}',
    phasesEmpty: 'Esta rutina no tiene fases definidas.',
    phaseNotFound: 'No encontramos esa fase.',
    week: 'Semana {{number}}',
    weeksCount: '{{count}} semanas',
    deload: 'descarga',
    day: 'Día {{number}}',
    daysEmpty: 'Esta semana no tiene días definidos.',
    backToPrograms: 'Programas',
    backToProgram: 'Programa',
    backToPhase: 'Fase',
    superset: 'Superserie {{label}}',
    supersetHint: 'Alterna los ejercicios: {{sequence}} y descansa al cerrar la ronda.',
    colSet: 'Serie',
    colTempo: 'Tempo',
    tempoLegendOpen: 'Qué significa el tempo',
    tempoLegendTitle: 'Cómo leer el tempo',
    tempoLegendIntro:
      'El tempo es el tiempo bajo tensión de cada repetición. Cada dígito es una fase del movimiento, en segundos. Ejemplo: 3010 en una sentadilla.',
    tempoEccentric: '1.º — excéntrica: bajar el peso.',
    tempoBottom: '2.º — posición de abajo, donde el ejercicio suele ser más duro.',
    tempoConcentric: '3.º — concéntrica: subir el peso.',
    tempoTop: '4.º — posición de arriba, el inicio y la parte más fácil.',
    tempoCompound: 'Un tempo como 2210+2010 son dos: el primero para las series principales y el segundo para la back-off.',
    colRest: 'Desc',
    colWeight: 'Peso',
    colReps: 'Reps',
    ...
    scopeProgram: 'Todo el programa · todas las semanas',
    revertSubstitution: 'Volver al ejercicio del programa',
    lastTimeYouDid: 'La última vez hiciste {{name}}',
...
const en: typeof es = {
  ...
  training: {
    ...
    cardNone: 'You have not picked a plan yet.',
    cardPickPlan: 'Pick a plan',
    cardWeekOf: 'Week {{week}} of {{total}}',
    cardToday: 'Today',
    cardNext: 'Next',
    cardRestDay: 'Rest day.',
    cardPlanOver: 'Your plan ended on {{date}}.',
    cardPlanOverPending: 'Your plan ended on {{date}} · {{count}} workouts left.',
    cardFinishPlan: 'Finish plan',
    cardKeepGoing: 'Keep going',
    ...
    planDates: '{{start}} → {{end}}',
    planProgress: '{{done}} of {{planned}} workouts',
    planWeeks: '{{count}} weeks',
    startPlan: 'Start',
    startPlanTitle: 'Start {{name}}',
    startPlanDescription:
      'The plan is scheduled week by week from the Monday you pick, with each day on its own weekday.',
    startPlanDate: 'Starts on Monday',
    startPlanSummary: '{{weeks}} weeks · ends on {{end}}',
    startPlanConfirm: 'Start the plan',
    startPlanReplace: 'This abandons your current plan ({{name}}). Anything logged is kept.',
    startPlanRoutine: 'Routine',
    starting: 'Starting…',
    thisWeek: 'This week',
    weekAdherence: '{{done}}/{{planned}}',
    status_today: 'Today',
    ...
    lastTime: 'Last time · {{when}}: {{sets}}',
    lastTimeNever: 'No previous records',
    historyDescription: 'Every time you logged this exercise, newest first.',
    historyEmpty: 'You have not logged this exercise yet.',
    historyUndated: 'no date',
    historySubstituted: 'sub.',
    routineTitle: 'Routine',
    routineDescription: 'This program has several routines; pick the one you will follow.',
    routineDays: '{{count}} days/week',
    routineCount: '{{count}} routines available',
    pickRoutine: 'Pick a routine to activate this program.',
    envGym: 'gym',
    envHome: 'home',
    activeTag: 'active',
    ...
    phase: 'Phase {{number}}',
    phasesEmpty: 'This routine has no phases defined.',
    phaseNotFound: 'We could not find that phase.',
    week: 'Week {{number}}',
    ...
    backToProgram: 'Program',
    backToPhase: 'Phase',
    superset: 'Superset {{label}}',
    supersetHint: 'Alternate the exercises: {{sequence}} and rest after closing the round.',
    colSet: 'Set',
    colTempo: 'Tempo',
    tempoLegendOpen: 'What tempo means',
    tempoLegendTitle: 'How to read the tempo',
    tempoLegendIntro:
      'Tempo is the time under tension of each repetition. Every digit is a phase of the lift, in seconds. Example: 3010 on a squat.',
    tempoEccentric: '1st — eccentric: lowering the weight.',
    tempoBottom: '2nd — bottom position, usually the hardest part of the lift.',
    tempoConcentric: '3rd — concentric: lifting the weight.',
    tempoTop: '4th — top position, the start and easiest part of the lift.',
    tempoCompound: 'A tempo like 2210+2010 is two: the first for the top sets, the second for the back-off set.',
    colRest: 'Rest',
    colWeight: 'Weight',
    colReps: 'Reps',
    ...
    scopeProgram: 'Whole program · every week',
    revertSubstitution: 'Back to the program exercise',
    lastTimeYouDid: 'Last time you did {{name}}',
