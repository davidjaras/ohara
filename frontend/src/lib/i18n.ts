...
const es = {
  ...
  weeklyChart: {
    ...
    description: 'Verde: meta cumplida · azul: por debajo · la línea punteada es la meta vigente',
...
const en: typeof es = {
  ...
  weeklyChart: {
    ...
    description: 'Green: goal met · blue: below goal · the dashed line is the goal in effect',
